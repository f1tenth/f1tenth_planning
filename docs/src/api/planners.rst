...
Planners either directly produce vehicle controls that traverse an environment, or generate feasible trajectory for downstream controllers to track.
All planners are based on the following abstract class.
